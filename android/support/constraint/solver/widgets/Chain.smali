...
.method static applyChainConstraints(Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;Landroid/support/constraint/solver/LinearSystem;IILandroid/support/constraint/solver/widgets/ChainHead;)V
    ...
    .restart local v5    # "isChainSpread":Z
    ...
    invoke-virtual {v10, v1, v4, v5, v3}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    .local v4, "strength":I
    invoke-virtual {v10, v1, v3, v5, v4}, Landroid/support/constraint/solver/LinearSystem;->addEquality(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)Landroid/support/constraint/solver/ArrayRow;
    ...
    .restart local v27    # "strength":I
    invoke-virtual {v10, v1, v3, v2, v4}, Landroid/support/constraint/solver/LinearSystem;->addGreaterThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    .end local v2    # "begin":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .end local v4    # "strength":I
    .restart local v26    # "begin":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .restart local v27    # "strength":I
    :goto_c
    iget-object v1, v6, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListAnchors:[Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual {v10, v2, v3, v4, v5}, Landroid/support/constraint/solver/LinearSystem;->addLowerThan(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)V
    ...
    .line 196
    :cond_17
    iget-object v4, v11, Landroid/support/constraint/solver/widgets/ChainHead;->mWeightedMatchConstraintsWidgets:Ljava/util/ArrayList;

    .line 197
    .local v4, "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    if-eqz v4, :cond_1f
    ...
    iget-boolean v2, v11, Landroid/support/constraint/solver/widgets/ChainHead;->mHasUndefinedWeights:Z

    if-eqz v2, :cond_18

    iget-boolean v2, v11, Landroid/support/constraint/solver/widgets/ChainHead;->mHasComplexMatchWeights:Z

    if-nez v2, :cond_18

    .line 204
    iget v2, v11, Landroid/support/constraint/solver/widgets/ChainHead;->mWidgetsMatchCount:I
    ...
    .local v3, "i":I
    .local v5, "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 209
    .local v0, "match":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    move/from16 v36, v1
    ...
    iget-boolean v1, v11, Landroid/support/constraint/solver/widgets/ChainHead;->mHasComplexMatchWeights:Z
    ...
    .end local v4    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .local v37, "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    ...
    .local v39, "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    invoke-virtual {v10, v1, v4, v7, v6}, Landroid/support/constraint/solver/LinearSystem;->addEquality(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)Landroid/support/constraint/solver/ArrayRow;
    ...
    .line 217
    .end local v37    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .end local v38    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v39    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v4    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    ...
    .end local v6    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v7    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v37    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .restart local v38    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v39    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    invoke-virtual {v10, v4, v6, v7, v8}, Landroid/support/constraint/solver/LinearSystem;->addEquality(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;II)Landroid/support/constraint/solver/ArrayRow;
    ...
    .end local v5    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v41, "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 233
    invoke-virtual {v10, v5}, Landroid/support/constraint/solver/LinearSystem;->addConstraint(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .end local v41    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v5, "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :cond_1c
    move-object/from16 v41, v5
    ...
    .line 236
    .end local v5    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v41    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :goto_15
    move-object v4, v0
    ...
    .line 207
    .end local v0    # "match":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v1    # "currentWeight":F
    .end local v4    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v5    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :goto_16
    add-int/lit8 v3, v3, 0x1
    ...
    .line 259
    .local v24, "endTarget":Landroid/support/constraint/solver/SolverVariable;
    ...
    .end local v37    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .local v30, "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    move/from16 v4, v27
    ...
    .end local v38    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v31, "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .local v32, "begin":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    move/from16 v8, v28
    ...
    .end local v30    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .end local v31    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v32    # "begin":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v24    # "endTarget":Landroid/support/constraint/solver/SolverVariable;
    .end local v37    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .end local v38    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v39    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v30    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .restart local v31    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 304
    iget-object v5, v9, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListAnchors:[Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .local v28, "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .local v29, "beginNext":Landroid/support/constraint/solver/SolverVariable;
    .local v31, "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    :goto_26
    if-eqz v28, :cond_33
    ...
    .local v27, "beginAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .local v40, "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    move/from16 v8, v34

    move-object/from16 v41, v9

    .end local v9    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v41, "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    move/from16 v9, v36
    ...
    .line 319
    .end local v27    # "beginAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v40    # "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v41    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .end local v28    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .end local v29    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    .end local v31    # "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    .restart local v39    # "next":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v40    # "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v41    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :goto_2a
    invoke-virtual/range {v41 .. v41}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getVisibility()I
    ...
    .end local v1    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .restart local v28    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v2    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    .local v28, "beginNext":Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 371
    .end local v28    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    ...
    .end local v2    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    .end local v3    # "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    .restart local v29    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    .local v31, "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    :goto_32
    if-eqz v28, :cond_43
    ...
    .end local v6    # "beginAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .local v34, "beginAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    move-object/from16 v6, v29
    ...
    .end local v8    # "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v38, "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    move v8, v0
    ...
    .line 388
    .end local v20    # "beginTarget":Landroid/support/constraint/solver/SolverVariable;
    .end local v34    # "beginAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v38    # "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .restart local v38    # "previousVisibleWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .local v23, "next":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :goto_35
    invoke-virtual/range {v39 .. v39}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getVisibility()I
